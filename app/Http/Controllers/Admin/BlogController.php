...
class BlogController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.blog.index',compact('src','listaMigalhas','listaBlog','listaCategorias')); 
    }
    ...
    ->update(['blog_titulo'=>$request->blog_titulo,'blog_descricao'=>$request->blog_descricao,'blog_data'=>date('Y-m-d'),'categ_id'=>$request->categ_id]))
{
    ...
    public function blogsingle($id){
        ...
        $blog="active";
        $listaCategorias=CatBlog::all();
        return view('admin.blog.blog_single',compact('src','listaPublicacao','blog','listaCategorias','listaUltimas'));
    }
    ...
    public function listaBlogcateg($id){
        ...
        $listaUltimas=Blog::listaBlog();
        $listaCategorias=CatBlog::all();
        return view('admin.blog.blogCat',compact('src','listaPublicacao','blog','listaUltimas','listaCategorias'));
    }
