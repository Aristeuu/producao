...
class RegistarController extends Controller
{
    ...
    {    
       ...
       $validacao = \Validator::make($user,[
        ...
        'telefone.required'=>'Por favor, informe o contacto válido',
       ...
       //Mail::to('juneidy.24@hotmail.com')->send(new UserRegisterEmail($user));
    ...
    if($request->tipo=="formador"){
       ...
       if(DB::table('formador')->insert(['id_user' => $idUser])){
        Session::flash('sms','Acessa o email para activar a tua conta');
