   ...
   //Método que lista as aulas associado a um único módulo
    ...
    public static function listaCurso($id){
     ...
     public static function listaAulaCurso($id){
        ...
        ->select('aulas.id','aulas.aula_titulo','aulas.aula_duracao','modulo.modulo_titulo','aulas.modulo_id','aulas.aula_link','aulas.aula_status','aulas.aula_conteudo','aulas.aula_descricao')
        ->where('cursos.id',$id)
        ->paginate(10);
        return $listaBlog;
    }
