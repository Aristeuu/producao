...
<div class="site">
    ...
    <div class="base-geral">
			<div class="caixa">
                <h2 class="titulo"><span class="case"><i class="ico curso"></i>{{$curso->curso_nome}}</span><i class="seta"></i></h2>
                @if($comprovante->isEmpty())
                    @if($compras[0]->status=='PE')
			        <a href="/pagamento/{{$curso->id}}" type="button" class="btn btn-danger"><i class="marcado"></i></i>Pagar Curso</a>
                    @endif
                 @else
						...
						<div class="caixa">
							...
							<div class="caixa-video">
								<div class="caixa-embed">
                                    @if($curso->curso_link!=null)
									<iframe src="{{$curso->curso_link}}" class="embed-item" width="655" height="360"  allowfullscreen></iframe>
                                    @else
                                    <img src="http://localhost/yetoafrica/storage/app/public/{{$curso->curso_img}}" style="	max-width: 100%;	width: 360px; height: 260px; object-fit: cover;" alt="a">
                                    @endif
...
@foreach($listAulas as $aulas)	
            ...
            <!-- Aproveitar esta secção para descarregar ebook
				...
				<div class="col-9 mb-3">
					...
					<div class="caixa">
						<span class="titulo2">ARQUIVOS DISPONÍVEÍS PARA DOWNLOADS</span>						
							<ul>
								<li><a href="http://producao.yetoafrica.com/storage/app/public/" class="icon" target="_blank">Conteúdo complementar</a></li>	
