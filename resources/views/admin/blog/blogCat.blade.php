                ...
                <div class="mu-course-container mu-blog-archive">
                  ...
                  @foreach($listaPublicacao as $lista)
                    <div class="col-md-6 col-sm-6">
                      <article class="mu-blog-single-item">
                        <figure class="mu-blog-single-img">
                          <a href="/blogfront/{{base64_encode($lista->id)}}"><img src="{{$src}}{{$lista->blog_foto}}" style="	max-width: 100%;	width: 360px; height: 260px; object-fit: cover;" alt="img"></a>
                   ...
                   <div class="mu-latest-course-single-contbottom">
                    <a class="btn btn-blog" href="/blogfront/{{base64_encode($lista->id)}}">Detalhes</a>
                    </div>
