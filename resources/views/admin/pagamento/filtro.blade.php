        ...
        <div class="col-sm-11 col-xl-4 mg-t-20 mg-xl-t-0">
          ...
          <formulario action="{{ route("filtro")}}" method="post" enctype="multipart/form-data" token="{{ csrf_token() }}">
            ...
            <div class="row input-daterange">
              <div class="col-md-4">
                <label>De</label>
              <input type="date" name="from_date" id="from_date" class="form-control" placeholder="from Date" value="{{$fromDate}}">
               </div>
               <div class="col-md-4">
                 <label>Para</label>
                 <input type="date" name="to_date" id="to_date" class="form-control" placeholder="to Date" value="{{$toDate}}">
               </div>
