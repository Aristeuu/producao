            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="mu-about-us-left">
                  <!-- Start Title -->
                  <div class="mu-title ">
                    <h2>Na <strong>yetoáfrica</strong> você Ensina Aprende e Soluciona</h2>              
                  </div>
                  <!-- End Title -->
        ...
        <div class="col-md-4 col-sm-6">
                  <div class="col-item">
                                ...
                                <a href="/detalhes/{{base64_encode($lista->id)}}"> 
                                  <img src="{{$src}}{{$lista->curso_img}}" style="	max-width: 100%;	width: 360px; height: 260px; object-fit: cover;" alt="a" /></a>
                                </div>
                                <div class="info">
                                    <div class="row">
                  ...
                  <article class="mu-blog-single-item">
                    <figure class="mu-blog-single-img">
                      <a href="/blogfront/{{base64_encode($lista->id)}}">
                        <img src="{{$src}}{{$lista->blog_foto}}" style="	max-width: 100%;	width: 360px; height: 260px; object-fit: cover;" ></a>
