...
<div>    
  ...
  <a v-if="criar && !modal" v-bind:href="criar">Criar</a>
      <modal_link v-if="criar && modal" tipo="button" nome="adicionar" titulo="Conteudo" css="btn btn-success"></modal_link>    
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                       ...
                       <tr v-for="(item,index) in lista">
                        ...
                        <td>{{item.id}}</td> 
                          <td><img :src="'http://localhost:82/nossafrica/storage/app/public/'+item.blog_foto" alt="" class="img-responsive img-rounded img-thumbnail" width="120px"></td> 
                          <td>{{item.blog_titulo}}</td> 
                           <td>{{item.cat_nome}}</td> 
                          <td>{{item.blog_data}}</td> 
