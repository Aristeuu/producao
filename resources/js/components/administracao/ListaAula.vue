...
<div>    
  ...
  <a v-if="criar && !modal" v-bind:href="criar">Criar</a>
      <modal_link v-if="criar && modal" tipo="button" nome="adicionar" titulo="Nova Aula" css="btn btn-success"></modal_link>    
        ...
        <hr>
                <table class="table table-striped">
                    ...
                    <tbody>
                       ...
                       <td>{{item.id}}</td> 
                           <td>{{item.aula_titulo}}</td>
                           <td>{{item.aula_duracao}}</td>
                           <td>{{item.modulo_titulo}}</td> 
                                    ...
                                    <td v-if="editar || deletar"> 
                                     ...
                                     <a v-if="ver && !modal" v-bind:href="editar" class="btn btn-info btn-xs"><i class="fa fa-edit"></i> editar </a>
