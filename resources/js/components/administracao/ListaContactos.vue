...
<div>    
  ...
  <a v-if="criar && !modal" v-bind:href="criar">Criar</a>
      <modal_link v-if="criar && modal" tipo="button" nome="adicionar" titulo="Novo Contacto" css="btn btn-success"></modal_link>    
                    ...
                    <tbody>
                       ...
                       <tr v-for="(item,index) in lista">
                        ...
                        <td>{{item.id}}</td> 
                           ...
                           <td>{{item.contacto_nome}}</td>
                           <td>{{item.contacto_email}}</td>
                           <td>{{item.contacto_assunto}}</td> 
                            <td v-html="item.contacto_descricao"></td> 
