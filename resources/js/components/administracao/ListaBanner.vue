...
<div>    
  ...
  <a v-if="criar && !modal" v-bind:href="criar">Criar</a>
      <modal_link v-if="criar && modal" tipo="button" nome="adicionar" titulo="Banners" css="btn btn-success"></modal_link>    
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                       ...
                       <tr v-for="(item,index) in lista">
                        ...
                        <td>{{item.id}}</td> 
                          <td><img :src="'http://localhost:82/nossafrica/storage/app/public/'+item.banner_img" alt="" class="img-responsive img-rounded img-thumbnail" width="120px"></td> 
