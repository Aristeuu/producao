...
<div>    
  ...
  <a v-if="criar && !modal" v-bind:href="criar">Criar</a>
      <modal_link v-if="criar && modal" tipo="button" nome="adicionar" titulo="Novo Módulo" css="btn btn-success"></modal_link>    
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                       ...
                       <tr v-for="(item,index) in lista">
                        ...
                        <td>{{item.id}}</td> 
                           <td>{{item.modulo_titulo}}</td>
                           <td v-html="item.modulo_descricao"></td>
                         ...
                         <td v-if="editar || deletar"> 
                                  ...
                                  <a v-if="ver" v-bind:href="ver+item.id" class="btn btn-xs btn-success"><i class="fa fa-eye"></i>aulas </a>
                                         ...
                                         <span v-if="!token">  
                                            <a v-if="ver && !modal" v-bind:href="ver" class="btn btn-xs btn-success"><i class="fa fa-eye"></i>aula </a>
                                         <modal_link v-if="ver && modal" v-bind:item="item" v-bind:url="ver" tipo="button" nome="ver" css="btn btn-xs btn-success" titulo="ver aula" clas="fa fa-eye"></modal_link> 
                                         ...
                                         <span v-if="token && !deletar">  
                                            <a v-if="ver && !modal" v-bind:href="ver" class="btn btn-success"><i class="fa fa-eye"></i>ver</a>
                                         <modal_link v-if="ver && modal" v-bind:item="item" v-bind:url="ver" tipo="button" nome="ver" css="btn btn-xs btn-warning" titulo="ver aula" clas="fa fa-eye"></modal_link> 
...
<script>
    ...
    export default {
     props:['titulos','itens','criar','editar','deletar','token','status','modal','ordem','ordemcol','ver','sms'],
       data: function(){
        return {
          buscar:'',
