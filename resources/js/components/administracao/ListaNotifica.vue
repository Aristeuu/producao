...
<div>    
  ...
  <a v-if="criar && !modal" v-bind:href="criar">Criar</a>
      <modal_link v-if="criar && modal" tipo="button" nome="adicionar" titulo="Novo Usuário" css="btn btn-success"></modal_link>    
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                       ...
                       <tr v-for="(item,index) in lista">
                        ...
                        <td>{{item.id}}</td> 
                           <td>{{item.notifica_titulo}}</td>
                           <td>{{item.name}}</td>
                           <td>{{item.notifica_data}}</td>
